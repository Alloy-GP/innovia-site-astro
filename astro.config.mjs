...
export default defineConfig({
  ...
  redirects: {
    ...
    '/guest-blog-neighborhood-mailboxes-a-comprehensive-guide-for-hoa-and-property-managers/': '/board-education/',
    ...
    '/8-strategies-to-prevent-crime-and-bolster-safety-in-your-neighborhood/': '/board-education/',
    ...
    '/guest-partner-blog-budget-mailboxes-who-is-responsible-for-cluster-mailboxes/': '/board-education/',
